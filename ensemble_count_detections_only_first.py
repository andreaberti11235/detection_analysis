...
def main():
    ...
    parser.add_argument('-n', '--first_n', type=int, default=2, help='Keep first n detected elements with the highest confidence values')
    ...
    for element in glob.glob(os.path.join(gt_dir, '*')):
        ...
        pred_fusion = sorted_list[:first_n]
